  ...
  return (
    <div className={styles.container}>
      ...
      <section className="white-background">
        ...
        <div className="text-center font-medium pt-14 text-xs	">1st anniversary</div>
    ...
    <div className="leading-6 text-xs	font-normal pt-10 px-4 pb-10	">
    {
        //改行コードで分割し、ループ表示
      ...
      <div className="section__head__group text-center pb-10">
        <div className="text-center font-medium pt-14 text-xs	">お祝いしよう!</div>
        <div className="text-3xl font-bold pt-4">
      {
        //改行コードで分割し、ループ表示
        ...
        <div className="leading-6 text-xs	font-normal pt-6 px-4 text-left	">
    {
        //改行コードで分割し、ループ表示
    ...
    <div className="content__sub__wrap px-5">
      ...
      <div className="leading-6 content__sub__setumei__naiyou text-xs	font-normal pt-6 pb-12 ">
        {bunsyu}
      </div>
    </div>
    </div>
